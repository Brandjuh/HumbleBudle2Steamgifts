...
(function (root) {
  ...
  HSG.SELECTORS = {
    humble: {
      ...
      /** Waar de spelnaam in zo'n rij staat, op volgorde van voorkeur. */
      rowName: '.game-name, .js-game-name, [class*="game-name"], h4, h3',
      /** Platform-icoontjes; Humble gebruikt een `hb-`-iconenfont. */
      platformIcon: '[class*="hb-"], [class*="platform"], [class*="icon-"]',
